...
from parsers.mover.serialiser import convert_decimal_to_float, to_json
...
@pytest.mark.parametrize("gen,s", [([Decimal('1.01')], '[1.01]'), ([Decimal(
    '1.0100000000000000088817841970012523233890533447265625')], '[1.01]'), ])
